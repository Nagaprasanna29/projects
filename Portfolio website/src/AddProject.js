...
const res=await axios.post("http://127.0.0.1:9000/api/project/add",newProject);
...
<input type="text" name="imageUrl" id="imageUrl"
 className="form-control" required onChange={this.onChange}/>
</div>
<div className="form-group">
...
<input type="text" className="form-control" name="excerpt" id="excerpt"
onChange={this.onChange} required/>
</div>
<SimpleMDE onChange={this.onBodyChange}
options={{hideIcons:["preview","side-by-side","fullscreen"],}}/>
<button className="btn btn-dark btn-block my-5" type="submit"
